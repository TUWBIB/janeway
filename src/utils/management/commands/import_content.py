...
def get_nav_children(children):
    ...
    for litag in children.find_all("li"):
        ...
        child_list.append({"text": a.text, "href": a.attrs["href"]})
    return child_list
...
def generate_cms_pages(object, nav_items, content):
    for item in nav_items:
        ...
        if html is not None:
            ...
            nav_item = generate_nav_entry(
                object, new_cms_page, True if item["children"] else False, False
            )
        ...
        for child in item["children"]:
            ...
            if html is not None:
                ...
                generate_nav_entry(
                    object, child_cms_page, False, new_cms_page, nav_item
                )
