    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            ...
            if self.instance.content_type == journal_type:
                self.journal = journal_type.get_object_for_this_type(
            ...
            if self.instance.content_type == press_type:
                self.press = press_type.get_object_for_this_type(
                    pk=self.instance.object_id
                )
        ...
        if custom_templates:
            self.fields["template"].widget = forms.Select(choices=custom_templates)
        else:
