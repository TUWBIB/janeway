...
def process_scss():
    ...
    paths = [
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/foundation-sites/scss/'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/motion-ui/src/')
    ]

    # File dirs
    app_scss_file = os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/scss/app.scss')
    app_css_file = os.path.join(settings.BASE_DIR, 'static/TUW_SHOWCASE/css/app.css')
...
def process_js():
    ...
    """
    source_paths = [
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/js/admin.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/js/app.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/js/footnotes.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/js/table_of_contents.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/js/text_resize.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/js/toastr.js'),
    ]
    dest_path = os.path.join(settings.BASE_DIR, 'static/TUW_SHOWCASE/js/app.js')
    min_path = os.path.join(settings.BASE_DIR, 'static/TUW_SHOWCASE/js/app.min.js')
...
def process_fonts():
    ...
    fonts_path = os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/fonts/')
    static_fonts = os.path.join(settings.BASE_DIR, 'static/TUW_SHOWCASE/fonts/')
...
def process_images():
    ...
    image_path = os.path.join(settings.BASE_DIR, 'themes/TUW_SHOWCASE/assets/img/')
    static_images = os.path.join(settings.BASE_DIR, 'static/TUW_SHOWCASE/img/')
...
def process_journals(override_css_dir, paths):
    ...
    for journal in journals:
        ...
        if os.path.isfile(journal_header_image):
            ...
            dest_path = os.path.join(settings.BASE_DIR, 'static', 'TUW_SHOWCASE', 'img', 'journal_header{0}.png'.format(journal.id))
...
def create_paths():
    base_path = os.path.join(settings.BASE_DIR, 'static', 'TUW_SHOWCASE')
    ...
    override_css_dir = os.path.join(settings.BASE_DIR, 'static', 'TUW_SHOWCASE', 'css')
