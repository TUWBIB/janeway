...
def create_paths():
    base_path = os.path.join(settings.BASE_DIR, 'static', 'TUW')
    folders = ['css', 'js']
...
def build():
    ...
    create_paths()
    print('Copying CSS')
    copy_file('themes/TUW/assets/css/bootstrap.css', 'static/TUW/css/bootstrap.css')
    copy_file('themes/TUW/assets/js/bootstrap.js', 'static/TUW/js/bootstrap.js')
