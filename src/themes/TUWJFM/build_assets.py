...
def build():
    ...
    create_paths()
    print('Copying CSS')
    copy_file('themes/TUWJFM/assets/css/bootstrap.css', 'static/TUWJFM/css/bootstrap.css')
    copy_file('themes/TUWJFM/assets/js/bootstrap.js', 'static/TUWJFM/js/bootstrap.js')
