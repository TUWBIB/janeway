...
def process_scss():
    ...
    paths = [
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/foundation-sites/scss/'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/motion-ui/src/')
    ]

    # File dirs
    app_scss_file = os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/scss/app.scss')
    app_css_file = os.path.join(settings.BASE_DIR, 'static/TUW_ARW/css/app.css')
...
def process_js():
    ...
    """
    source_paths = [
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/js/admin.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/js/app.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/js/footnotes.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/js/table_of_contents.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/js/text_resize.js'),
        os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/js/toastr.js'),
    ]
    dest_path = os.path.join(settings.BASE_DIR, 'static/TUW_ARW/js/app.js')
    min_path = os.path.join(settings.BASE_DIR, 'static/TUW_ARW/js/app.min.js')
...
def process_fonts():
    ...
    fonts_path = os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/fonts/')
    static_fonts = os.path.join(settings.BASE_DIR, 'static/TUW_ARW/fonts/')
...
def process_images():
    ...
    image_path = os.path.join(settings.BASE_DIR, 'themes/TUW_ARW/assets/img/')
    static_images = os.path.join(settings.BASE_DIR, 'static/TUW_ARW/img/')
...
def process_journals(override_css_dir, paths):
    ...
    for journal in journals:
        ...
        if os.path.isfile(journal_header_image):
            ...
            dest_path = os.path.join(settings.BASE_DIR, 'static', 'TUW_ARW', 'img', 'journal_header{0}.png'.format(journal.id))
...
def create_paths():
    base_path = os.path.join(settings.BASE_DIR, 'static', 'TUW_ARW')
    ...
    override_css_dir = os.path.join(settings.BASE_DIR, 'static', 'TUW_ARW', 'css')
